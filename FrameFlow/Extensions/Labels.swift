...
final class Texts {
    ...
    enum Settings {
        ...
        static let language = NSLocalizedString("SettingsLanguage", comment: "Language")
        static let languageContent = NSLocalizedString("SettingsLanguageContent", comment: "English")
